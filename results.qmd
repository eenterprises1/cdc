...
```
Although not perfect, we see a strong correlation that supports the study: select southern states have a higher proportion of the population comprised of black people, and it coincides with the states that have had higher increases of deaths due to Alzheimer's disease.
...
A large bulk of what is under unintentional injuries is drug overdoses. 
...
Averaging the rate of opioid dispense rate (via phramancies and medical facilities), here are top 8 highest states that were dispensing the most amount of perscription opioids. 
...
```
We can observe that these states accelerate in dispensing opioids and then dramatically decrease the opiod dispensing around 2012. 
...
What is interesting about the Unintentional deaths in these top 8 states is that they start to climb. This could be due to the fact that  people initially developed addictions during the years of aggressive dispensing. Then, after a few years, the death rates started to increase. 
...
We see that choosing 8 states that have had the highest average death rate from 2006 to 2020 and choosing 8 states that have had the highest average opioid dispensing, we can see that 5 of states intersect. There is significant overlap between the states that had the highest average opioid dispensing rates and the states that had the highest average death rates. 



### Analyzing Suicide

This topic is extremely broad and difficult to summarize. There are many life factors such as depression, mental illness, lack of access to mental health care, isolation, and quality of life that can contribute to the rising rates. However, there is peculiar pattern that emerges in terms of population density and suicide rates.  Consider these top 10 states with highest average suicide rates:
...
```
These states have had the highest suicide rate on average from 1999 to 2020. We can see that there is interesting relationship between where most suicide tend to occur and the type of state it is. In particular, many of these states tend to have a sparsely population density. In other words, the land mass tends to be big compared to the population residing on that land mass. We import a data set to isolate states that have the lower population density. Consider this next table of lowest population densities in US by state:
...
There is a peculiar pattern that emerges. Comparing the top 10 states for lowest population density and the top 8 states for the highest suicide rate, there is an overlap of 6 states.
