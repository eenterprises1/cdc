...
-   The first map (i.e. map with bubbles) shows which states have the highest death rate per 100,000 people.

-   The second map (i.e. heatmap) will show which states have seen the most significant increase expressed as a percentage change from 1999 to 2020.
...
-->
*For example: consider choosing Alzheimer's Disease and focusing on Mississippi. The bubble map shows that Mississippi has had the highest age-adjusted death rate due to Alzheimer's in the United States: 58 deaths per 100,000 people. Moreover, not only does it have the highest death rate, but it has seen the largest growth since 1999 in this metric: a 336% increase.*
<!--
